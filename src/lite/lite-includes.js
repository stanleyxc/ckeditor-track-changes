...
*/
	...
	global.rangy.createCoreModule("DomUtil", [], function(api, module) {
		var UNDEF = "undefined";
		var util = api.util;
	...
	global.rangy.createCoreModule("DomRange", ["DomUtil"], function(api, module) {
		var dom = api.dom;
		var util = api.util;
	...
	global.rangy.createCoreModule("WrappedRange", ["DomRange"], function(api, module) {
	...
	*/
	...
	global.rangy.createCoreModule("WrappedSelection", ["DomRange", "WrappedRange"], function(api, module) {
